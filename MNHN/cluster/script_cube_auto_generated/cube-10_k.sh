...
cd /trinity/home/pturk/Projet_MNHN/MNHN/cluster/script_cube_auto_generated
python ./cube-10_k.py $path_folder_pID $path_folder_data_split $path_new_folder
date
